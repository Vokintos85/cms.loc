...
<?php $view->render('templates/header'); ?>
    ...
    <header class="intro-header" style="background-image: url('/content/themes/monaco/assets/img/contact-bg.jpg')">
        <div class="container">
            <div class="row">
...
<?php $view->render('templates/footer'); ?>